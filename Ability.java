class Ability extends Champion{
  ...
  Ability(){
    //Constructor for creating an ability will accept parameter to set ability name and base damage stats
    //I.e will populate array for now
  }
  
  
  public double[] attack(champ, enemyChamp){
